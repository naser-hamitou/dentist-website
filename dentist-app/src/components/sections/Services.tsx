  ...
  return (
    <section id="services" className="py-24 bg-white">
      <div className="container mx-auto px-6">
        <Reveal className="text-center max-w-3xl mx-auto mb-16" direction="up">
          ...
          {SERVICES.map((service, index) => {
            ...
            return (
              <Reveal
                ...
                className="h-full"
              >
                <div className="group h-full p-8 rounded-2xl bg-slate-50 hover:bg-blue-600 hover:text-white transition duration-300 border border-slate-100 hover:border-blue-600 hover:shadow-xl hover:-translate-y-1">
